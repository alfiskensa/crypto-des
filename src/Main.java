...
//                            1, 2, 2, 2, 2, 2, 2, 1 };
        ...
        int[] shiftBits = { 2, 2, 2, 1, 2, 2, 2, 1, 2, 2, 2, 1, 2, 2, 2, 1 };
        ...
        {
        	System.out.println("Process generate internal keys");
            String keys[] = new String[16];
            // first key permutation
            
            key = permutation(PC1, key);
            System.out.println("first permutation key: "+hextoBin(key));
...
//        String key = "AABB09182736CCDD";
        ...
        String name = "ALFIRAMD";
        
        
        DES cipher = new DES();
        System.out.println("Encryption:\n");
        text = cipher.encrypt(bytesToHex(name.getBytes()), bytesToHex(key.getBytes()));
        System.out.println(
            "\nCipher Text: " + text.toUpperCase() + "\n");
        System.out.println("Decryption\n");
        text = cipher.decrypt(bytesToHex(name.getBytes()), bytesToHex(key.getBytes()));
        System.out.println(
            "\nPlain Text: "
            + text.toUpperCase());
    }
